...
extern  SPI_HandleTypeDef hspi2;    /*clocked from 72MHz*/
				...
				uint8_t *readBuffer)
{
	...
	for(i=0; i<headerLength; i++)
	{
		...
		HAL_SPI_TransmitReceive(&hspi2, &headerBuffer[i], (uint8_t *)&temp, 1, HAL_MAX_DELAY);
	}

	/* for the data buffer use LL functions directly as the HAL SPI read function
	 * has issue reading single bytes */
	HAL_SPI_TransmitReceive(&hspi2, &headerBuffer[i], (uint8_t *)readBuffer, readlength, HAL_MAX_DELAY);
